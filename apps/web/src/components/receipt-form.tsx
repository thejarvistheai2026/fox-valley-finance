...
interface ReceiptFormDialogProps {
  ...
  onSubmit: (data: Omit<ReceiptType, 'id' | 'display_id' | 'project_id' | 'vendor_id' | 'created_at' | 'updated_at' | 'status' | 'created_by' | 'tax_total'>) => void;
...
export function ReceiptFormDialog({
  ...
  const handleSubmit = (data: ReceiptFormData) => {
    ...
    onSubmit(submitData as Omit<ReceiptType, 'id' | 'display_id' | 'project_id' | 'vendor_id' | 'created_at' | 'updated_at' | 'status' | 'created_by' | 'tax_total'>);
    setOpen(false);
    form.reset();
